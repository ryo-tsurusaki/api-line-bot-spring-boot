...
public class OpenAiChatServiceTest {
    ...
    class OpenAiChat {
        ...
        void success() {
            ...
            doReturn(openAiChatData).when(openAIChatRepository).openAiChat(messageText);
        ...
        void failure() {
            ...
            doThrow(new RuntimeException(errorMessage)).when(openAIChatRepository).openAiChat(messageText);
